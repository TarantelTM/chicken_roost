...
public class AChickenBasaltNaturalEntitySpawningConditionProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		if ((world instanceof Level _lvl ? _lvl.dimension() : Level.OVERWORLD) == (Level.NETHER)) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new AChickenBasaltEntity(ChickenRoostModEntities.A_CHICKEN_BASALT.get(), _level);
