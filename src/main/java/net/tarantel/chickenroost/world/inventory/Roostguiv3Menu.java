...
public class Roostguiv3Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Roostguiv3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ChickenRoostModMenus.ROOSTGUIV_3, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 25, 44) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (stack.is(ItemTags.create(new ResourceLocation("forge:roost/tier3"))));
			}
		}));
