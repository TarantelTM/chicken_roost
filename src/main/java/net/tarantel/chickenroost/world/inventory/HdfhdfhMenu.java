...
public class HdfhdfhMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HdfhdfhMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ChickenRoostModMenus.HDFHDFH, id);
