...
public class AChickenSoulsteelEntity extends Chicken {
	public AChickenSoulsteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_SOULSTEEL.get(), world);
	}

	public AChickenSoulsteelEntity(EntityType<AChickenSoulsteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
